...
// ─── Get All Categories  (GET /api/store/getCategories) ─────────────────────
// Global list — any logged-in store can read this to populate the product
// category dropdown. Not scoped by storeId since categories aren't store-owned.
