  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs mt-0.5 truncate" style={{ color: uploaded ? "#4f6072" : "#80756b", fontWeight: uploaded ? 600 : 400 }}>
...
export default function DeliveryPartnerRegistration() {
  ...
  const [drivingLicense, setDrivingLicense] = useState<UploadState>({ name: null, uploaded: false });
  const [vehicleRC, setVehicleRC] = useState<UploadState>({ name: null, uploaded: false });
  const [profilePhoto, setProfilePhoto] = useState<UploadState>({ name: null, uploaded: false });
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden font-sans" style={{ backgroundColor: "#fff8f4" }}>
      {/* ── Left Panel ── */}
      <aside className="hidden md:flex relative w-[40%] h-full overflow-hidden flex-shrink-0" style={{ backgroundColor: "#291803" }}>
        {/* BG overlay */}
        <div
      ...
      {/* ── Right Panel ── */}
      <section className="flex-1 h-full overflow-y-auto" style={{ scrollbarWidth: "thin", scrollbarColor: "#d2c4b9 #f4ece8" }}>
        <div className="max-w-[480px] mx-auto px-6 py-10">
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6d614f" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0 mt-0.5">
          ...
          <form onSubmit={(e) => { e.preventDefault(); alert("Application submitted! Our team will contact you soon."); }} className="space-y-8">
            ...
            <fieldset className="space-y-4">
              ...
              <div>
                ...
                <input type="text" placeholder="John Doe" className={inputClass} style={inputStyle} onFocus={handleFocus} onBlur={handleBlur} />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="tel" placeholder="+1 (555) 000-0000" className={`${inputClass} pl-9`} style={inputStyle} onFocus={handleFocus} onBlur={handleBlur} />
                </div>
              </div>
            ...
            <fieldset className="space-y-4">
                  ...
                  {vehicles.map((v) => {
                    ...
                    return (
                      <button
                        ...
                        style={{
                          backgroundColor: active ? "#735a3e" : "white",
                          color: active ? "white" : "#1e1b19",
                          borderColor: active ? "#735a3e" : "#d2c4b9",
                        }}
                      >
                        {v}
                      </button>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" placeholder="ABC-1234" className={`${inputClass} pl-9`} style={inputStyle} onFocus={handleFocus} onBlur={handleBlur} />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" placeholder="LIC-556677" className={`${inputClass} pl-9`} style={inputStyle} onFocus={handleFocus} onBlur={handleBlur} />
                </div>
              </div>
            </fieldset>
            ...
            <fieldset className="space-y-4">
              ...
              <div className="space-y-3">
                <DocumentCard
                  ...
                  onUpload={(n) => setDrivingLicense({ name: n, uploaded: true })}
                />
                <DocumentCard
                  ...
                  sub="PDF, JPG or PNG (Max 5MB)"
                  upload={vehicleRC}
                  onUpload={(n) => setVehicleRC({ name: n, uploaded: true })}
                />
                <DocumentCard
                  ...
                  label="Profile Photo"
                  sub="Clear recent photograph"
                  upload={profilePhoto}
                  onUpload={(n) => setProfilePhoto({ name: n, uploaded: true })}
                />
              </div>
            </fieldset>
            ...
            <div className="pt-2 pb-8">
              <button
                type="submit"
                className="w-full h-12 text-xs font-bold tracking-widest uppercase rounded-lg transition-all hover:opacity-90 active:scale-[0.98]"
                style={{
              ...
              <p className="text-center mt-3 text-xs text-gray-500">
                ...
                <button type="button" onClick={() => navigate("/login")} className="font-bold hover:underline" style={{ color: "#735a3e" }}>
                  Sign In
                </button>
              </p>
            </div>
