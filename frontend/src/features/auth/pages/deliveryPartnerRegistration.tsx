// src/features/auth/components/DeliveryPartnerRegistration.tsx
...
export default function DeliveryPartnerRegistration() {
  ...
  const [vehicleRC, setVehicleRC] = useState<UploadState>({
    file: null,
    name: null,
    uploaded: false,
  });
  ...
  /**
   * Driver/Store OTP verified → navigate to pending page.
   * We do NOT populate the auth store here — drivers are not "logged in",
   * they are just email-verified and awaiting admin approval.
   * The backend should NOT set an Access_Token cookie for pending users.
   */
            ...
            <fieldset className="space-y-4">
              ...
              <div className="space-y-3">
                <DocumentCard
                  ...
                  onUpload={(f) =>
                    setDrivingLicense({ file: f, name: f.name, uploaded: true })
                  }
                />
                <DocumentCard
                  icon={
                  ...
                  upload={vehicleRC}
                  onUpload={(f) =>
                    setVehicleRC({ file: f, name: f.name, uploaded: true })
                  }
                />
                <DocumentCard
                  icon={
